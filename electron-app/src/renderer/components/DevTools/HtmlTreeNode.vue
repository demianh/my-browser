  ...
  <div class="html-tree-node">
    <span class="html-tree-node__opener" @click="open = !open">
      <span v-if="node.children && node.children.length">
        <span v-if="open" class="html-tree-node__open"><i class="far fa-minus-square"></i></span>
        <span v-if="!open" class="html-tree-node__close"><i class="far fa-plus-square"></i></span>
      </span>
    </span>
