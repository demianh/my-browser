<template>
  <div class="css-rule-declarations">
    <div v-for="decl in declarations">
      <span class="css-rule-declarations__key">{{decl.name}}</span>:
      <span class="css-rule-declarations__value" v-for="(keyword, index) in decl.value"><!--
