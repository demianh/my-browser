...
test('Simple Rules', async t => {
	...
	t.is(JSON.stringify(nodes), '[{"type":"style","rules":[[{"type":"element","selector":"h1","arguments":[]}],[{"type":"element","selector":"h2","arguments":[]}]],"declarations":[]}]');

	nodes = parser.parse('h1 div, h2 a:visited {}');
	t.is(JSON.stringify(nodes), '[{"type":"style","rules":[[{"type":"element","selector":"h1","arguments":[]},{"type":"element","selector":"div","arguments":[]}],[{"type":"element","selector":"h2","arguments":[]},{"type":"element","selector":"a:visited","arguments":[]}]],"declarations":[]}]');
...
test('Simple Attributes', async t => {
	...
	t.is(JSON.stringify(nodes), '[{"type":"style","rules":[[{"type":"element","selector":"h1","arguments":[]}]],"declarations":[{"name":"color","value":"red"}]}]');
...
test('Multiple Attributes', async t => {
	...
	t.is(JSON.stringify(nodes), '[{"type":"style","rules":[[{"type":"element","selector":"h1","arguments":[]}]],"declarations":[{"name":"color","value":"red"},{"name":"font-family","value":"helvetica,arial,sans-serif"}]}]');

	// duplicate rules, use latest only
	nodes = parser.parse('h1 { color: red; color: blue; }');
	t.is(JSON.stringify(nodes), '[{"type":"style","rules":[[{"type":"element","selector":"h1","arguments":[]}]],"declarations":[{"name":"color","value":"blue"}]}]');
